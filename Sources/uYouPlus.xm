...
- (NSData *)elementData {
    ...
    if ([[NSUserDefaults standardUserDefaults] boolForKey:@"hideShortsCells"]) {
        ...
        BOOL hasShorts = ([description containsString:@"shorts_shelf"] || [description containsString:@"shorts_video_cell"] || [description containsString:@"shorts_grid_shelf_footer"]);
